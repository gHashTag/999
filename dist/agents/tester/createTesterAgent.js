...
export function createTesterAgent({ allTools, apiKey, modelName, log, // log is needed if used inside system prompt or hooks (removed hooks for now)
 }) {
    return createAgent({
        name: "Tester Agent",
...
//# sourceMappingURL=createTesterAgent.js.map